...
def main() :
    ...
    axes[1, 0].plot(data['time'], data['dist_mean'], label='mean')
    ...
    axes[1, 1].plot(data['time'], data['vel_mean'], label='mean')
    ...
    axes[2, 0].plot(data['time'], np.abs(data['force_mean']), label='mean')
