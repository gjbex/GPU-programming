...
int main(int argc, char *argv[]) {
    Kokkos::initialize(argc, argv);
    {
        ...
        Kokkos::fence();
        std::cout << "parallel_for over league members, team members, single per team" << std::endl;
        Kokkos::parallel_for(policy, KOKKOS_LAMBDA(const member_t& thread) {
        ...
        Kokkos::fence();
        std::cout << "parallel_for over league members, team members, single per thread" << std::endl;
        Kokkos::parallel_for(policy, KOKKOS_LAMBDA(const member_t& thread) {
